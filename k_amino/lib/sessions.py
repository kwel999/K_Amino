...
class Session(Headers):
    ...
    def __init__(self, client: Optional[Session] = None, proxies: Optional[Dict[str, str]] = None, deviceId: Optional[str] = None) -> None:
    ...
    def postRequest(self, url: str, data: Union[str, Dict[str, Any], BinaryIO, None] = None, newHeaders: Optional[Dict[str, str]] = None, webRequest: bool = False, minify: bool = False) -> Union[Dict[str, Any], NoReturn]:
