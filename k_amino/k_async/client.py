...
class AsyncClient(AsyncWss, AsyncSession):
    ...
    async def sid_login(self, sid: str, socket = False) -> Account:
    ...
    async def upload_image(self, image: BinaryIO) -> str:
    ...
    async def send_verify_code(self, email: str) -> Json:
    ...
    async def accept_host(self, requestId: str, chatId: str) -> Json:
        ...
        """
        req = await self.postRequest(f"/g/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept")
        return Json(req)

    async def verify_account(self, email: str, code: str) -> Json:
    ...
    async def restore(self, email: str, password: str) -> Json:
    ...
    async def delete_account(self, password: Optional[str] = None, secret: Optional[str] = None) -> Json:
    ...
    async def claim_coupon(self) -> Json:
    ...
    async def change_amino_id(self, aminoId: str) -> Json:
    ...
    async def get_my_communities(self, start: int = 0, size: int = 25) -> CommunityList:
    ...
    async def get_chat_threads(self, start: int = 0, size: int = 25) -> ThreadList:
        ...
        """
        req = await self.getRequest(f"/g/s/chat/thread?type=joined-me&start={start}&size={size}")
    ...
    async def get_from_link(self, link: str) -> FromCode:
    ...
    async def flag_community(self, comId: str, reason: str, flagType: int = 0) -> Json:
        """Flag a community.
    ...
    async def leave_community(self, comId: int) -> Json:
        """Leave a community.
    ...
    async def join_community(self, comId: int, invId: Optional[str] = None) -> Json:
        """Join a community.
    ...
    async def get_member_following(self, userId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/g/s/user-profile/{userId}/joined?start={start}&size={size}")
    ...
    async def get_member_followers(self, userId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/g/s/user-profile/{userId}/member?start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList
    ...
    async def get_member_visitors(self, userId: str, start: int = 0, size: int = 25) -> VisitorsList:
        ...
        """
        req = await self.getRequest(f"/g/s/user-profile/{userId}/visitors?start={start}&size={size}")
    ...
    async def get_wall_comments(self, userId: str, sorting: str = "newest", start: int = 0, size: int = 25) -> CommentList:
        ...
        if sorting not in ["newest", "oldest", "vote"]:
            raise ValueError("Sorting must be one of 'newest', 'oldest', or 'vote', not %r" % sorting)
        req = await self.getRequest(f"/g/s/user-profile/{userId}/g-comment?sort={sorting}&start={start}&size={size}")
    ...
    async def get_community_info(self, comId: str) -> Community:
        ...
        """
        link = (f"/g/s-x{comId}/community/info"
    ...
    async def mark_as_read(self, chatId: str) -> Json:
        """Mark as read a chat
    ...
    async def delete_message(self, chatId: str, messageId: str) -> Json:
        """Delete a message.
    ...
    async def get_chat_messages(self, chatId: str, start: int = 0, size: int = 25) -> MessageList:
        ...
        """
        req = await self.getRequest(f"/g/s/chat/thread/{chatId}/message?v=2&pagingType=t&size={size}")
        return GetMessages(req["messageList"]).GetMessages

    async def get_message_info(self, messageId: str, chatId: str) -> Message:
    ...
    async def reset_password(self, email: str, password: str, code: str, deviceId: Optional[str] = None) -> Json:
    ...
    async def change_password(self, password: str, newPassword: str) -> Json:
    ...
    async def comment(self, comment: str, userId: str, replyTo: Optional[str] = None) -> Json:
    ...
    async def invite_by_host(self, chatId: str, userId: Union[str, list]) -> Json:
    ...
    async def kick(self, chatId: str, userId: str, rejoin: bool = True) -> Json:
        ...
        """
        req = await self.deleteRequest(f"/g/s/chat/thread/{chatId}/member/{userId}?allowRejoin={rejoin.real}")
        return Json(req)

    async def get_invise_users(self, master_type = "newest", start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/g/s/user-profile?type={master_type}&start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList

    async def invite_to_chat(self, chatId: str, userId: Union[str, List[str]]) -> Json:
    ...
    async def invise_invite(self, chatId: str, userId: Union[str, List[str]]) -> Json:
        """Invite a user or users to global chat.
    ...
    async def unblock(self, userId: str) -> Json:
        """Unblock a user.
    ...
    async def get_public_chats(self, filterType: str = "recommended", start: int = 0, size: int = 50) -> ThreadList:
        ...
        """
        req = await self.getRequest(f"/g/s/chat/thread?type=public-all&filterType={filterType}&start={start}&size={size}")
        return ThreadList(req["threadList"]).ThreadList

    async def get_content_modules(self, version: int = 2) -> Json:
        req = await self.getRequest(f"/g/s/home/discover/content-modules?v={version}")
        return Json(req)

    async def get_banner_ads(self, size: int = 25, pagingType: str = "t") -> ItemList:
    ...
    async def get_announcements(self, lang: str = "en", start: int = 0, size: int = 20) -> BlogList:
        req = await self.getRequest(f"/g/s/announcement?language={lang}&start={start}&size={size}")
        return BlogList(req["blogList"]).BlogList

    async def get_public_ndc(self, content_language: str = "en", size: int = 25) -> CommunityList:
    ...
    async def search_community(self, q: str, lang: str = "en", start: int = 0, size: int = 25) -> CommunityList:
        """Search communities.
        ...
        """
        req = await self.getRequest(f"/g/s/community/search?q={q}&language={lang}&completeKeyword=1&start={start}&size={size}")
        return CommunityList(req["communityList"]).CommunityList
    ...
    async def invite_to_voice_chat(self, chatId: str, userId: str) -> Json:
        ...
        req = await self.postRequest(f"/g/s/chat/thread/{chatId}/vvchat-presenter/invite", data)
        return Json(req)
    ...
    async def get_all_users(self, usersType: str = "recent", start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/g/s/user-profile?type={usersType}&start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList
    ...
    async def get_chat_members(self, chatId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/g/s/chat/thread/{chatId}/member?start={start}&size={size}&type=default&cv=1.2")
        return UserProfileList(req["memberList"]).UserProfileList

    async def get_from_id(self, objectId: str, objectType: int, comId: Optional[str] = None) -> FromCode:
    ...
    async def chat_settings(
        ...
        if isinstance(doNotDisturb, bool):
            ...
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/member/{self.uid}/alert", data)
            res.append(Json(req))
        if isinstance(viewOnly, bool):
            view = "enable" if viewOnly else "disable"
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/view-only/{view}")
            res.append(Json(req))
        if isinstance(canInvite, bool):
            can = "enable" if canInvite else "disable"
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/members-can-invite/{can}")
            res.append(Json(req))
        if isinstance(canTip, bool):
            can = "enable" if canTip else "disable"
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/tipping-perm-status/{canTip}")
            res.append(Json(req))
        if isinstance(pin, bool):
            action = "pin" if pin else "unpin"
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/{action}")
            res.append(Json(req))
        if coHosts:
            data = {
            ...
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/co-host", data)
            res.append(Json(req))
        return res

    async def like_comment(self, commentId: str, blogId: Optional[str] = None, userId: Optional[str] = None) -> Json:
    ...
    async def unlike_comment(self, commentId: str, blogId: Optional[str] = None, userId: Optional[str] = None) -> Json:
    ...
    async def edit_chat(
        ...
        if background:
            ...
            req = await self.postRequest(f"/g/s/chat/thread/{chatId}/member/{self.uid}/background", data)
            res.append(Json(req))
        if announcement:
    ...
    async def remove_cohost(self, chatId: str, userId: str) -> Json:
    ...
    async def edit_comment(self, commentId: str, comment: str, userId: str, replyTo: Optional[str] = None) -> Comment:
    ...
    async def get_comment_info(self, commentId: str, userId: str) -> Comment:
    ...
    async def get_notifications(self, start: int = 0, size: int = 25, pagingType: str = "t") -> NotificationList:
        ...
        NotificationList
            _description_
        """
        req = await self.getRequest(f"/g/s/notification?pagingType={pagingType}&start={start}&size={size}")
    ...
    async def get_notices(self, start: int = 0, size: int = 25, noticeType: str = "usersV2", status: int = 1) -> NoticeList:
        ...
        """
        req = await self.getRequest(f"/g/s/notice?type={noticeType}&status={status}&start={start}&size={size}")
