...
class AsyncSubClient(AsyncAcm, AsyncSession):
    ...
    def __init__(self, comId: int, client: AsyncClient, proxies: Optional[dict] = None, acm: bool = False, debug: bool = False):
        self.comId = comId
        if acm:
            AsyncAcm.__init__(self, comId=self.comId, client=client, proxies=proxies)
        else:
            AsyncSession.__init__(self, client=client, proxies=proxies, debug=debug)
    ...
    async def get_video_rep_info(self, chatId: str) -> RepInfo:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/thread/{chatId}/avchat-reputation")
        return RepInfo(req)
    ...
    async def claim_video_rep(self, chatId: str) -> RepInfo:
        ...
        """
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/avchat-reputation")
        return RepInfo(req)
    ...
    async def join_chat(self, chatId: str) -> Json:
        ...
        """
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{self.uid}")
        return Json(req)

    async def upload_media(self, file: BinaryIO, fileType: Literal['audio', 'image']) -> str:
        ...
        req = await self.postRequest("/g/s/media/upload", data=file, newHeaders=newHeaders)
    ...
    async def leave_chat(self, chatId: str) -> Json:
        ...
        """
        req = await self.deleteRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{self.uid}")
        return Json(req)
    ...
    async def get_member_following(self, userId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/user-profile/{userId}/joined?start={start}&size={size}")
    ...
    async def get_member_followers(self, userId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/user-profile/{userId}/member?start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList
    ...
    async def get_member_visitors(self, userId: str, start: int = 0, size: int = 25) -> VisitorsList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/user-profile/{userId}/visitors?start={start}&size={size}")
    ...
    async def get_chat_threads(self, start: int = 0, size: int = 25) -> ThreadList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/thread?type=joined-me&start={start}&size={size}")
    ...
    async def get_chat_messages(self, chatId: str, start: int = 0, size: int = 25) -> MessageList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/thread/{chatId}/message?v=2&pagingType=t&size={size}")
    ...
    async def get_user_blogs(self, userId: str, start: int = 0, size: int = 25) -> BlogList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/blog?type=user&q={userId}&start={start}&size={size}")
    ...
    async def get_user_wikis(self, userId: str, start: int = 0, size: int = 25) -> WikiList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/item?type=user-all&start={start}&size={size}&cv=1.2&uid={userId}")
        return WikiList(req["itemList"]).WikiList

    async def get_all_users(self, usersType: str = "recent", start: int = 0, size: int = 25) -> UserProfileList:
    ...
    async def get_chat_members(self, chatId: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member?start={start}&size={size}&type=default&cv=1.2")
    ...
    async def get_online_users(self, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/live-layer?topic=ndtopic:x{self.comId}:online-members&start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList

    async def get_public_chats(self, filterType: str = "recommended", start: int = 0, size: int = 25) -> ThreadList:
    ...
    async def full_embed(self, chatId: str, link: str, image: BinaryIO, message: str) -> Json:
        ...
        res = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/message", data)
        return Json(res)
    ...
    async def send_web_message(
        ...
        res = await self.postRequest("/add-chat-message", data, webRequest=True)
        return Json(res)
    ...
    async def unfollow(self, userId: str) -> Json:
        ...
        """
        req = await self.postRequest(f"/x{self.comId}/s/user-profile/{userId}/member/{self.uid}")
        return Json(req)

    async def follow(self, userId: Union[str, list]) -> Json:
    ...
    async def invite_to_chat(self, chatId: str, userId: Union[str, list]) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/invite", data=data)
        return Json(req)
    ...
    async def edit_chat(
        ...
        if background:
            ...
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{self.uid}/background", data)
            res.append(Json(req))
        if announcement:
    ...
    async def chat_settings(
        ...
        if isinstance(doNotDisturb, bool):
            ...
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{self.uid}/alert", data)
            res.append(Json(req))
        if isinstance(viewOnly, bool):
            view = "enable" if viewOnly else "disable"
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/view-only/{view}")
            res.append(Json(req))
        if isinstance(canInvite, bool):
            can = "enable" if canInvite else "disable"
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/members-can-invite/{can}")
            res.append(Json(req))
        if isinstance(canTip, bool):
            can = "enable" if canTip else "disable"
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/tipping-perm-status/{can}")
            res.append(Json(req))
        if isinstance(pin, bool):
            action = "pin" if pin else "unpin"
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/{action}")
            res.append(Json(req))
        if coHosts:
            data = {
    ...
    async def like_blog(self, blogId: Optional[str] = None, wikiId: Optional[str] = None) -> Json:
        """Like a blog or wiki.
    ...
    async def unlike_blog(self, blogId: Optional[str] = None, wikiId: Optional[str] = None):
    ...
    async def change_titles(self, userId: str, titles: List[str], colors: List[str]) -> Json:
    ...
    async def like_comment(self, commentId: str, blogId: Optional[str] = None, wikiId: Optional[str] = None, userId: Optional[str] = None) -> Json:
    ...
    async def unlike_comment(self, commentId: str, blogId: Optional[str] = None, wikiId: Optional[str] = None, userId: Optional[str] = None) -> Json:
    ...
    async def delete_comment(self, commentId: str, blogId: Optional[str] = None, wikiId: Optional[str] = None, userId: Optional[str] = None) -> Json:
        """Delete a comment.
    ...
    async def get_wall_comments(
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/user-profile/{userId}/comment?sort={sorting}&start={start}&size={size}")
    ...
    async def vote_comment(self, commentId: str, blogId: str, value: bool = True) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/blog/{blogId}/comment/{commentId}/vote?cv=1.2&value=1", data)
        return Json(req)
    ...
    async def vote_poll(self, optionId: str, blogId: str) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/blog/{blogId}/poll/option/{optionId}/vote", data)
        return Json(req)

    async def get_blog_info(self, blogId: Optional[str] = None, wikiId: Optional[str] = None, folderId: Optional[str] = None) -> GetInfo:
    ...
    async def get_blogs(self, start: int = 0, size: int = 25) -> BlogList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/feed/featured?start={start}&size={size}")
    ...
    async def get_blogs_more(self, start: int = 0, size: int = 25) -> BlogList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/feed/featured-more?start={start}&size={size}")
        return BlogList(req["blogList"]).BlogList
    ...
    async def get_blogs_all(self, start: int = 0, size: int = 25, pagingType: str = "t") -> BlogList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/feed/blog-all?pagingType={pagingType}&start={start}&size={size}")
    ...
    async def delete_message(self, chatId: str, messageId: str, asStaff: bool = False, reason: Optional[str] = None) -> Json:
        ...
        if asStaff and reason:
            ...
            req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}/admin", data)
        else:
            req = await self.deleteRequest(f"/x{self.comId}/s/chat/thread/{chatId}/message/{messageId}")
        return Json(req)
    ...
    async def invite_by_host(self, chatId: str, userId: str) -> Json:
        ...
        """
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{userId}/invite-av-chat")
        return Json(req)
    ...
    async def ban(self, userId: str, reason: str, banType: Optional[int] = None) -> Json:
    ...
    async def send_warning(self, userId: str, reason: Optional[str] = None) -> Json:
        """Warn a user.
    ...
    async def invite_to_voice_chat(self, chatId: str, userId: str) -> Json:
        ...
        req = await self.postRequest(f"/g/x{self.comId}/chat/thread/{chatId}/vvchat-presenter/invite", data)
        return Json(req)
    ...
    async def activate_status(self, status: int = 1) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/user-profile/{self.uid}/online-status", data)
        return Json(req)

    async def subscribe(self, userId: str, autoRenew: bool = False, transactionId: Optional[str] = None) -> Json:
    ...
    async def submit_wiki(self, wikiId: str, message: Optional[str] = None) -> Json:
    ...
    async def get_chat_bubbles(self, start: int = 0, size: int = 25) -> BubbleList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/chat-bubble?type=all-my-bubbles&start={start}&size={size}")
        return BubbleList(req["chatBubbleList"]).BubbleList

    async def select_bubble(self, bubbleId: str, applyToAll: bool = False, chatId: Optional[str] = None) -> Json:
        """Apply a chat bubble.
    ...
    async def get_chat_bubble_templates(self, start: int = 0, size: int = 25) -> BubbleTemplates:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/chat/chat-bubble/templates?start={start}&size={size}")
    ...
    async def upload_custom_bubble(self, templateId: str) -> Json:
        ...
        """
        req = await self.postRequest(f"/x{self.comId}/s/chat/chat-bubble/templates/{templateId}/generate")
        return Json(req)
    ...
    async def kick(self, chatId: str, userId: str, rejoin: bool = True) -> Json:
        ...
        """
        req = await self.deleteRequest(f"/x{self.comId}/s/chat/thread/{chatId}/member/{userId}?allowRejoin={rejoin.real}")
        return Json(req)
    ...
    async def send_active_time(self, tz: int = 0, timers: Optional[List[Dict[str, int]]] = None) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/community/stats/user-active-time", data, minify=True)
        return Json(req)

    async def transfer_host(self, chatId: str, userIds: List[str]) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer", data)
        return Json(req)
    ...
    async def accept_host(self, chatId: str, requestId: str) -> Json:
        ...
        req = await self.postRequest(f"/x{self.comId}/s/chat/thread/{chatId}/transfer-organizer/{requestId}/accept", data)
        return Json(req)

    async def set_cohost(self, chatId: str, userId: Union[str, List[str]]) -> Json:
    ...
    async def play_quiz(self, quizId: str, questions: List[str], answers: List[str], mode: Literal[0, 1] = 0) -> Json:
        """Play a quiz.
    ...
    async def get_quiz_rankings(self, quizId: str, start: int = 0, size: int = 25) -> QuizRankings:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/blog/{quizId}/quiz/result?start={start}&size={size}")
    ...
    async def search_user(self, username: str, start: int = 0, size: int = 25) -> UserProfileList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/user-profile?type=name&q={username}&start={start}&size={size}")
        return UserProfileList(req["userProfileList"]).UserProfileList
    ...
    async def search_blog(self, words: str, start: int = 0, size: int = 25) -> BlogList:
        ...
        BlogList
            The search result object.
        """
        req = await self.getRequest(f"/x{self.comId}/s/blog?type=keywords&q={words}&start={start}&size={size}")
        return BlogList(req["blogList"]).BlogList
    ...
    async def get_notifications(self, start: int = 0, size: int = 25, pagingType: str = "t") -> NotificationList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/notification?pagingType={pagingType}&size={size}")
    ...
    async def get_notices(self, start: int = 0, size: int = 25, noticeType: str = "usersV2", status: int = 1) -> NoticeList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/notice?type={noticeType}&status={status}&start={start}&size={size}")
    ...
    async def sendWebActive(self) -> Json:
        ...
        res = await self.postRequest("/community/stats/web-user-active-time", data, webRequest=True)
        return Json(res)

    async def get_recent_blogs(self, pageToken: Optional[str] = None, start: int = 0, size: int = 25) -> BlogList:
        ...
        """
        req = await self.getRequest(f"/x{self.comId}/s/feed/blog-all?pagingType=t&start={start}&size={size}")
        return RecentBlogs(req["BlogList"]).RecentBlogs
